...
}), withPropsOnChange(['data', 'unit', 'getColor'], function (_ref4) {
    var data = _ref4.data,
        unit = _ref4.unit,
...
var enhance = (function (Component) {
    ...
    switch (Component.displayName) {
        case 'Waffle':
            return compose.apply(undefined, [defaultProps(implDefaultProps)].concat(commonEnhancers, [core.withMotion(), withPropsOnChange(['computedData', 'defs', 'fill'], function (_ref5) {
