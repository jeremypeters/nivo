...
var TreeMapPlaceholdersPropTypes = TreeMapPropTypes;

var TreeMapHtmlPropTypes = _extends({}, commonPropTypes, {
    nodeComponent: PropTypes.func.isRequired
});

var TreeMapHtmlCanvasPropTypes = _extends({}, commonPropTypes, {
...
var TreeMapPlaceholdersDefaultProps = TreeMapDefaultProps;
...
var props = Object.freeze({
	...
	TreeMapPlaceholdersPropTypes: TreeMapPlaceholdersPropTypes,
	TreeMapHtmlPropTypes: TreeMapHtmlPropTypes,
	TreeMapHtmlCanvasPropTypes: TreeMapHtmlCanvasPropTypes,
	TreeMapDefaultProps: TreeMapDefaultProps,
	TreeMapPlaceholdersDefaultProps: TreeMapPlaceholdersDefaultProps,
...
var TreeMap$1 = enhance(TreeMap);

var ResponsiveTreeMap = (function (props) {
    return React__default.createElement(
        ...
        function (_ref) {
            var width = _ref.width,
                height = _ref.height;
            return React__default.createElement(TreeMap$1, _extends({ width: width, height: height }, props));
        }
    );
});
...
var TreeMapHtml$1 = enhance(TreeMapHtml);

var ResponsiveTreeMapHtml = (function (props) {
    return React__default.createElement(
        core.ResponsiveWrapper,
        null,
        function (_ref) {
            var width = _ref.width,
                height = _ref.height;
            return React__default.createElement(TreeMapHtml$1, _extends({ width: width, height: height }, props));
        }
    );
});
...
var TreeMapCanvas$1 = enhance(TreeMapCanvas);

var ResponsiveTreeMapCanvas = (function (props) {
    return React__default.createElement(
        core.ResponsiveWrapper,
        null,
        function (_ref) {
            var width = _ref.width,
                height = _ref.height;
            return React__default.createElement(TreeMapCanvas$1, _extends({ width: width, height: height }, props));
        }
    );
});
...
exports.TreeMapHtml = TreeMapHtml$1;
exports.ResponsiveTreeMapHtml = ResponsiveTreeMapHtml;
exports.TreeMapCanvas = TreeMapCanvas$1;
exports.ResponsiveTreeMapCanvas = ResponsiveTreeMapCanvas;
exports.TreeMapPropTypes = TreeMapPropTypes;
exports.TreeMapPlaceholdersPropTypes = TreeMapPlaceholdersPropTypes;
exports.TreeMapHtmlPropTypes = TreeMapHtmlPropTypes;
exports.TreeMapHtmlCanvasPropTypes = TreeMapHtmlCanvasPropTypes;
exports.TreeMapDefaultProps = TreeMapDefaultProps;
exports.TreeMapPlaceholdersDefaultProps = TreeMapPlaceholdersDefaultProps;
