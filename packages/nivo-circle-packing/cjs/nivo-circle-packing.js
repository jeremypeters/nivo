...
var ResponsiveBubble = function ResponsiveBubble(props) {
    return React__default.createElement(
        ...
        function (_ref) {
            var width = _ref.width,
                height = _ref.height;
            return React__default.createElement(Bubble$1, _extends({ width: width, height: height }, props));
        }
    );
};
...
var BubbleHtml$1 = enhance(BubbleHtml);
...
var ResponsiveBubbleHtml = function ResponsiveBubbleHtml(props) {
    return React__default.createElement(
        ...
        function (_ref) {
            var width = _ref.width,
                height = _ref.height;
            return React__default.createElement(BubbleHtml$1, _extends({ width: width, height: height }, props));
        }
    );
};
...
var BubbleCanvas$1 = enhance(BubbleCanvas);
...
var ResponsiveBubbleCanvas = function ResponsiveBubbleCanvas(props) {
    return React__default.createElement(
        ...
        function (_ref) {
            var width = _ref.width,
                height = _ref.height;
            return React__default.createElement(BubbleCanvas$1, _extends({ width: width, height: height }, props));
        }
    );
};
...
exports.BubbleHtml = BubbleHtml$1;
exports.ResponsiveBubbleHtml = ResponsiveBubbleHtml;
exports.BubbleCanvas = BubbleCanvas$1;
