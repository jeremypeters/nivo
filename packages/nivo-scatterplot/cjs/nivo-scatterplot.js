...
var enhance = (function (Component) {
    return compose(defaultProps(ScatterPlotDefaultProps), core.withTheme(), core.withColors(), core.withDimensions(), core.withMotion(), withPropsOnChange(['data', 'width', 'height', 'scales'], computeScales), pure)(Component);
});
